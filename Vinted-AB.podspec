#
#  Be sure to run `pod spec lint Vinted-AB.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ...
                   * High-level description - Identifiers are divided into some
                   ...
                   variants.
                   DESC
  s.homepage     = "https://github.com/vinted/ab-ios"
  ...
  #  profile URL.
  #
  s.author             = { "Sarunas Kazlauskas" => "sarunas.kazlauskas@vinted.com" }
  ...
  #
  s.source       = { :git => "https://github.com/vinted/ab-ios.git", :tag => "1.0-beta3" }
  ...
  s.source_files  = "Vinted-AB/Classes", "Vinted-AB/Classes/**/*.{h,m}"
